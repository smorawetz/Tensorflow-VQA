                    ...
                    for MAX_CHANGE in MAX_CHANGES:
                        for THREE_D in [False, True]:
                            ...
                            if THREE_D:
                                ...
                                plot_name = "{0}_3D_{1}_{2}_landscape_max{3}_npoints{4}_L{5}_T{6}_seed{7}.png".format(
                                    model_type,
                                    LAND_TYPE,
                                    LAND_TIME,
                                    MAX_CHANGE,
                                ...
                                plot_name = "{0}_{1}_{2}_landscape_max{3}_npoints{4}_L{5}_T{6}_seed{7}.png".format(
                                    model_type,
                                    LAND_TYPE,
                                    LAND_TIME,
                                    MAX_CHANGE,
